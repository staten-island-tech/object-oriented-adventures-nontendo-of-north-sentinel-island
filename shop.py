...
def visit_shop():
    ...
    print("   a. Tier 1 - +20% dmg, cost: 25 gold")
    print("   b. Tier 2 - +45% dmg, cost: 50 gold")
    print("   c. Tier 3 - +75% dmg, cost: 75 gold")
    print("   d. Tier 4 - +100% dmg, cost: 100 gold")
    ...
    if choose == '1':
        ...
        upgrade_percentages = {'a': 20, 'b': 45, 'c': 75, 'd': 100}
